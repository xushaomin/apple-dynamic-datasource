 ...
 * <pre/>
 */
package com.appleframework.dynamic.datasource.spring.boot.autoconfigure.hikari;
...
public class HikariCpConfig {
	...
	public HikariConfig toHikariConfig(HikariCpConfig globalConfig) {
		...
		Long tempInitializationFailTimeout = initializationFailTimeout == null
				? globalConfig.getInitializationFailTimeout() : initializationFailTimeout;
		...
		Boolean tempIsolateInternalQueries = isIsolateInternalQueries == null
				? globalConfig.getIsIsolateInternalQueries() : isIsolateInternalQueries;
