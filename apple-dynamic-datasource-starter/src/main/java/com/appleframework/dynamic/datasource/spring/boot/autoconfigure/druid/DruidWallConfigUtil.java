...
public final class DruidWallConfigUtil {
	...
	public static WallConfig toWallConfig(DruidWallConfig c, DruidWallConfig g) {
		...
		Boolean tempSelectHavingAlwayTrueCheck = c.getSelectHavingAlwayTrueCheck() == null 
				? g.getSelectHavingAlwayTrueCheck() : c.getSelectHavingAlwayTrueCheck();
		...
		Boolean tempConditionAndAlwayTrueAllow = c.getConditionAndAlwayTrueAllow() == null
				? g.getConditionAndAlwayTrueAllow() : c.getConditionAndAlwayTrueAllow();
		if (tempConditionAndAlwayTrueAllow != null && tempConditionAndAlwayTrueAllow) {
			wallConfig.setConditionAndAlwayTrueAllow(true);
		}
		Boolean tempConditionAndAlwayFalseAllow = c.getConditionAndAlwayFalseAllow() == null 
				? g.getConditionAndAlwayFalseAllow() : c.getConditionAndAlwayFalseAllow();
		if (tempConditionAndAlwayFalseAllow != null && tempConditionAndAlwayFalseAllow) {
			wallConfig.setConditionAndAlwayFalseAllow(true);
		}
		Boolean tempConditionDoubleConstAllow = c.getConditionDoubleConstAllow() == null
				? g.getConditionDoubleConstAllow() : c.getConditionDoubleConstAllow();
