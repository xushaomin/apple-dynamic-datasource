 ...
 * <pre/>
 */
package com.appleframework.dynamic.datasource.aop;

import com.appleframework.dynamic.datasource.matcher.ExpressionMatcher;
import com.appleframework.dynamic.datasource.matcher.Matcher;
import com.appleframework.dynamic.datasource.matcher.RegexMatcher;
	...
	private Pointcut buildPointcut(List<Matcher> matchers) {
		...
		for (Matcher matcher : matchers) {
			if (matcher instanceof RegexMatcher) {
				...
				Pointcut pointcut = new DynamicJdkRegexpMethodPointcut(regexMatcher.getPattern(), regexMatcher.getDs(),
						matchesCache);
